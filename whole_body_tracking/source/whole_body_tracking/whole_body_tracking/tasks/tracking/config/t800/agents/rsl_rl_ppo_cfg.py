...
@configclass
class T800BaoquanPPORunnerCfg(T800FlatPPORunnerCfg):
    experiment_name = "t800_baoquan_locomotion"
    policy = RslRlPpoActorCriticCfg(
        init_noise_std=0.20, noise_std_type="log", actor_hidden_dims=[512, 256, 128],
    ...
    algorithm = RslRlPpoAlgorithmCfg(
        ...
        num_learning_epochs=5, num_mini_batches=8, learning_rate=1.0e-4, schedule="adaptive",
