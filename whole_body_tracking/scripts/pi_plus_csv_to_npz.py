"""This script replay a motion from a csv file and output it to a npz file for pi_plus robot.

.. code-block:: bash

    # Usage
    python pi_plus_csv_to_npz.py --input_file /path/to/pi_plus_motion.csv --input_fps 30 --output_name pi_plus_motion
"""
...
parser = argparse.ArgumentParser(description="Replay motion from csv file and output to npz file for pi_plus.")
...
##
# Pre-defined configs for pi_plus
##
...
class ReplayMotionsSceneCfg(InteractiveSceneCfg):
    ...
    # articulation (Replaced with pi_plus)
...
def run_simulator(sim: sim_utils.SimulationContext, scene: InteractiveScene, joint_names: list[str]):
    ...
    while simulation_app.is_running():
        ...
        if reset_flag and not file_saved:
            ...
            # Save locally
            output_path = f"/tmp/{args_cli.output_name}.npz"
...
def main():
    ...
    # Run the simulator with pi_plus 21 joints exactly matching your config
    run_simulator(
        sim,
        scene,
        joint_names=[
